...
# This is every charachter you want to test.
...
# These are the charachters you want to remove from the test buffer. Add charachters to this as necessary. When you're done this is your complete list.
